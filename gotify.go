...
func (m MessageGotify) SendNotification() {
	...
	if err != nil {
		CreateFileDay(Message{Error: "Falha ao enviar Notificação via Gotify: ", Objects: []interface{}{resp}}, nil)
	}
	defer resp.Body.Close()

	if resp.StatusCode != http.StatusOK {
		CreateFileDay(Message{Error: "Não teve o Status OK do Gotify: ", Objects: []interface{}{resp}}, nil)
	}
}
